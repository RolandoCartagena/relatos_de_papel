...
export default function Checkout() {
  ...
  const hasPhysicalBooks = cart.some(item => item.type === 'physical');
  const shippingCost = hasPhysicalBooks
    ? (formData.shippingMethod === 'express' ? 9.99 : 4.99)
    : 0;
  const taxes = total * 0.21; // IVA 21%
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (validateForm()) {
      navigate('/payment', { state: { formData, finalTotal } });
    }
  };
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <form onSubmit={handleSubmit} className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white border-2 border-neutral-300 p-6">
              <h2 className="text-sm mb-4 pb-4 border-b-2 border-neutral-200">1. INFORMACIÓN DE CONTACTO</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm mb-2 text-neutral-700">Nombre *</label>
                    <input
                      type="text"
                      name="firstName"
                  ...
                  <div>
                    <label className="block text-sm mb-2 text-neutral-700">Apellidos *</label>
                    <input
                      type="text"
                      name="lastName"
                ...
                <div>
                  <label className="block text-sm mb-2 text-neutral-700">Teléfono *</label>
                  <input
                    type="tel"
                    name="phone"
            ...
            {hasPhysicalBooks && (
              <div className="bg-white border-2 border-neutral-300 p-6">
                <h2 className="text-sm mb-4 pb-4 border-b-2 border-neutral-200">2. DIRECCIÓN DE ENVÍO</h2>

                <div className="space-y-4">
                  <div>
                    <label className="block text-sm mb-2 text-neutral-700">Dirección *</label>
                    <input
                      type="text"
                      name="address"
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm mb-2 text-neutral-700">Ciudad *</label>
                      <input
                        type="text"
                        name="city"
                        value={formData.city}
                    ...
                    <div>
                      <label className="block text-sm mb-2 text-neutral-700">Departamento *</label>
                      <input
                        type="text"
                        name="state"
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm mb-2 text-neutral-700">Código Postal *</label>
                      <input
                        type="text"
                        name="zipCode"
                    ...
                    <div>
                      <label className="block text-sm mb-2 text-neutral-700">País *</label>
                      <select
                        name="country"
            ...
            {/* Shipping Method - Only for physical books */}
            {hasPhysicalBooks && (
              <div className="bg-white border-2 border-neutral-300 p-6">
                <h2 className="text-sm mb-4 pb-4 border-b-2 border-neutral-200">3. MÉTODO DE ENVÍO</h2>
                ...
                <div className="space-y-3">
                  <label className="flex items-center gap-3 p-4 border-2 border-neutral-300 cursor-pointer hover:bg-neutral-50">
                    ...
                    />
                    <div className="grow">
                      <div className="font-medium">Envío estándar (5-7 días)</div>
                      <div className="text-sm text-neutral-600">Entrega en horario laboral</div>
                    </div>
                  ...
                  <label className="flex items-center gap-3 p-4 border-2 border-neutral-300 cursor-pointer hover:bg-neutral-50">
                    ...
                    />
                    <div className="grow">
                      <div className="font-medium">Envío express (2-3 días)</div>
                      <div className="text-sm text-neutral-600">Entrega prioritaria</div>
                    </div>
            ...
            {!hasPhysicalBooks && (
              <div className="bg-blue-50 border-2 border-blue-300 p-4">
                <p className="text-blue-800">
                  ℹ️ Tu pedido contiene solo libros digitales. Recibirás los enlaces de descarga por email tras la confirmación del pago.
                </p>
              </div>
            )}
          </form>
          ...
          <div className="md:col-span-1">
            <div className="bg-white border-2 border-neutral-300 p-6 sticky top-4">
              <h2 className="text-sm mb-4 text-neutral-700">RESUMEN DEL PEDIDO</h2>

              <div className="space-y-3 mb-4 pb-4 border-b-2 border-neutral-200">
                {cart.map(item => (
                  <div key={item.id} className="flex justify-between text-sm">
                    <span className="grow pr-2">{item.title} × {item.quantity}</span>
              ...
              <button
                ...
                className="w-full px-6 py-4 bg-neutral-800 text-white border-2 border-neutral-900 hover:bg-neutral-700 flex items-center justify-center gap-2"
              >
                <CreditCard size={20} />
